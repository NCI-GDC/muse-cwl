...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="MuSE (v1.0rc_submission_c039ffa) pipeline SLURM script creator")
    ...
    for case in cases:
        ...
        for line in temp:
            ...
            if "XX_EXP_STRAT_XX" in line:
                line = line.replace("XX_EXP_STRAT_XX", str(args.exp_strat))
            slurm.write(line)
        slurm.close()
        temp.close()
